<template>
  <div>
		...
		style="background-image:url(/frontend/images/bg-01.jpg)">
					...
					<form>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none"
								src="/frontend/images/icons/icon-email.png" alt="ICON">
						</div>
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">
								<a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__"
									data-cfemail="670408091306041327021f060a170b024904080a">[email&#160;protected]</a>
							</p>
						</div>
					</div>
				</div>
